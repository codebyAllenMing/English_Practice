...
- **斷行規則改「句子優先 + 行內多數決」(2026-07-29)**:舊規則「講者變更即切」會產生斷頭碎片(Day 3 實測 467 行中 35 行無句尾標點,如 "It"/"really does.")。改為只在句尾標點斷行(60 詞保險上限)、整行講者由行內詞數多數決 → 碎片歸零(431 行/0 碎片)、句子完整、歸戶正確。曾評估的「AI merges 協議」因此不需要,校正維持行號 1:1
